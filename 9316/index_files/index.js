window.onload = function () {
    ...
    document.querySelector("body > mdui-layout > mdui-top-app-bar > mdui-top-app-bar-title").innerText = "Res 9.3.1.8"
}
...
if (localStorage.getItem("wzzdy_xgluatip") != "0.1") {
    ...
    // 设置<span>元素的文本内容  
    span.innerHTML = '<span slot="description">X式会社2区：905697062</span>';
    mdui.alert({
        headline: "提示",
        description: span,
        confirmText: "我知道了",
